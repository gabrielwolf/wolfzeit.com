...
<header class="banner navbar navbar-inverse navbar-fixed-bottom primary_navigation" role="banner">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo get_home_url(); ?>"><img alt="W O L F Z E I T Logo" onerror="this.onerror=null; this.src='<?php echo get_home_url(); ?>/app/uploads/logo.svg'" style="max-width:100px; margin-top: -4px; margin-right: 10px;" src="<?php echo get_home_url(); ?>/app/uploads/logo.svg"></a><!-- <a class="navbar-brand" href="<?php echo get_home_url(); ?>">W O L F Z E I T ⇢ Dein Fotograf, Designer & Tonmeister in Berlin und München</a> -->
    </div>
